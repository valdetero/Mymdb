...
namespace Xamarin.Forms.Platform.WinRT.Renderers
{
    public class ListViewRenderer : ViewRenderer<ListView, ListBox>
    {
        protected override void OnElementChanged(ElementChangedEventArgs<ListView> e)
        {
            ...
            //Element.ItemTapped += Element_ItemTapped;
        ...
        void Element_ItemTapped(object sender, ItemTappedEventArgs e)
        {
        ...
        {
            this.Element.NotifyRowTapped(((ListBox)sender).SelectedIndex);
        }
    }
}